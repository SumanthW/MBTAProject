...
select 3, 180,30, '30-day' from dual;
...
select 3, 5, to_date('01-07-2050','dd-mm-yyyy'), 2,  to_date('01-07-2020','dd-mm-yyyy'),3 from dual;
...
select 1, 'Card_Balance', to_date('010120 12:00:00','DDMMYY HH24:MI:SS'), 2, 20, 1 from dual union all
select 2, 'Ride', to_date('010120 11:00:00','DDMMYY HH24:MI:SS'), 2, 30, 2 from dual union all
select 3, 'Pass', to_date('010120 11:00:00','DDMMYY HH24:MI:SS'), 2, 30, 1 from dual;
...
select 2,to_date('010124 11:00:00','DDMMYY HH24:MI:SS'), to_date('010122 19:00:00','DDMMYY HH24:MI:SS'), 'Maintenance', CURRENT_TIMESTAMP, 2, 2, 2, 1, 1 from dual;
